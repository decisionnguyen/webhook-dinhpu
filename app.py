...
# fanpage token
PAGE_ACCESS_TOKEN = 'EAAEL3Fs9AZBsBAGKDiGoMyjkoxOIBzZBhEnJsidCYtMVpHiZBNCPKEiCQnhHuk4RAmsiVHMKEZB2ZCart9te7JJESxjfLzZArDZCNjs8WEl9xzTMT8gLFzcpW9Q1mjFJkCkZCZBL6KZBcNX50bKWsNHVXzhAWbKfNV0rRThohzdcf9nAZDZD'
# verify token
VERIFY_TOKEN = 'dinhpu@Vcc123**'
...
class BotControl(web.View):
                    ...
                    if messaging_event.get("message"):
                        ...
                        if any(["chào" in message_text.lower(), "hi " in message_text.lower(),
                            ...
                            await self.send_message(sender_id, "mình tên là bot demo aiohttp nha")
                                  ...
                                  "ai viết" in message_text.lower(), "ba mày" in message_text.lower(),
                                  "cha mày" in message_text.lower()
                                     , "bố mày" in message_text.lower(), "tía mày" in message_text.lower()]):
                            await self.send_message(sender_id,
                                                    "ahihi bạn vào đây để xem ai là người tạo ra mình nha :3 https://www.hocpython.com")
                        else:
                            await self.send_message(sender_id,
                                                    "Bạn dễ thương gì ấy ơi, ghé https://www.hocpython.com để ủng hộ ba mình nha :3 ")
                            await self.send_message(sender_id,
    ...
    async def send_greeting(self, message_text):
        ...
        async with aiohttp.ClientSession() as session:
            await session.post("https://graph.facebook.com/v3.0/me/thread_settings", params=params, headers=headers,
                               data=data)
